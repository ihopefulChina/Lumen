...
struct BrowserMenuHitTests {
    @Test func parsesFolderAndFileIdentifiers() {
        #expect(BrowserMenuHit.parseIdentifier("ossuno.folder:art/") == .folder("art/"))
        #expect(BrowserMenuHit.parseIdentifier("ossuno.file:cover.png") == .file("cover.png"))
        #expect(BrowserMenuHit.parseIdentifier("ossuno.folder:") == nil)
    ...
    @Test func registryPicksTheSmallestContainingCell() {
        ...
        registry.register(grid, id: "ossuno.folder:wrong/")
        registry.register(cell, id: "ossuno.folder:art/")
        registry.register(other, id: "ossuno.folder:refs/")
    ...
    @Test func descendantSearchFindsMarkerBehindAButton() {
        ...
        marker.identifier = NSUserInterfaceItemIdentifier("ossuno.folder:art/")
    ...
    @Test func resolveUsesRegistryBeforeFallingBackToEmpty() {
        ...
        let registry = BrowserItemHitRegistry()
        registry.register(cell, id: "ossuno.file:cover.png")
