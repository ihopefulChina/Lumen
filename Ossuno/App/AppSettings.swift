...
final class AppSettings {
    ...
    var imagesOnly: Bool {
        didSet { defaults.set(imagesOnly, forKey: Keys.browserMaterialFilter) }
    }
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        self.imagesOnly = defaults.object(forKey: Keys.browserMaterialFilter) as? Bool ?? false
    ...
    private enum Keys {
        ...
        static let browserMaterialFilter = "settings.browserMaterialFilter"
