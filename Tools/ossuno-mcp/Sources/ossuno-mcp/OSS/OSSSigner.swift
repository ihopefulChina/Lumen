...
// Copied verbatim from Ossuno/OSS/OSSSigner.swift.
// OSS V4 signing — do NOT rewrite; canonical request details are
// byte-identical with the official SignerV4.cc / Python SDK v2.
