...
struct GridInteractionProbeTests {
    @Test func gridFolderSingleClickSelects() throws {
        ...
        try harness.click(at: harness.center(ofMarker: "lumen.folder:\(folderKey)"), count: 1)
    ...
    @Test func gridFolderDoubleClickOpens() throws {
        ...
        try harness.click(at: harness.center(ofMarker: "lumen.folder:\(folderKey)"), count: 1)
        try harness.click(at: harness.center(ofMarker: "lumen.folder:\(folderKey)"), count: 2)
    ...
    @Test func gridFileSingleClickSelects() throws {
        ...
        try harness.click(at: harness.center(ofMarker: "lumen.file:\(fileKey)"), count: 1)
    ...
    @Test func gridCommandClickTogglesSelection() throws {
        ...
        try harness.click(at: harness.center(ofMarker: "lumen.folder:\(folderKey)"), count: 1, modifierFlags: [.command])
    ...
    @Test func gridEmptyClickClearsSelection() throws {
        ...
        let point = try harness.center(ofMarker: "lumen.folder:campaigns/2026-autumn/品牌规范/")
